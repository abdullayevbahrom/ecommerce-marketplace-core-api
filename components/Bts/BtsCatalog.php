...
final readonly class BtsCatalog
{
            ...
            'cities' => [
                ...
                9013 => [
                    ...
                    "name" => [
                        ...
                        "ru" => "Тупраккалинский район",
                        "en" => "Tuproqqala district"
                    ]
                ]
            ]
        ],
        ...
        30 => [
            ...
            'cities' => [
                ...
                3008 => [
                    ...
                    "code" => "3008",
                    "name" => [
                        "uz" => "Qo'shrobot tumani",
                        "ru" => "Кошрабадский район",
                        "en" => "Qoshrobot district"
                    ]
                ],
                3003 => [
                    "region_code" => "30",
    ...
    public const array INSIDES = [
        ...
        10 => [
            "id" => 10,
            "name" => [
                "uz" => "REKLAMA MAHSULOTLARI",
                "ru" => "РЕКЛАМНЫЕ ИЗДЕЛИЯ",
    ...
    public const array STATUSES = [
        100 => [
            ...
            "description" => [
                "uz" => "Buyurtma yuboruvchida, hali BTS tizimiga topshirilmagan.",
                "ru" => "Заказ у отправителя и еще не передан в систему BTS.",
                "en" => "The order is with the sender and has not been handed over to BTS yet."
            ],
            "next_possible_statuses" => [200]
        ],
        200 => [
            "code" => 200,
            ...
            "description" => [
                "uz" => "Kuryer jo‘natmani qabul qildi va jo‘natish ofisiga olib bormoqda.",
                "ru" => "Курьер принял отправление и везет его в офис отправления.",
                "en" => "The courier accepted the shipment and is taking it to the origin office."
            ],
            "next_possible_statuses" => [300]
        ],
        300 => [
            "code" => 300,
            "color_class" => 'label-warning',
            ...
            "description" => [
                "uz" => "Jo‘natma jo‘natish ofisida qabul qilindi.",
                "ru" => "Отправление принято в офисе отправления.",
                "en" => "The shipment has been received at the origin office."
            ],
            "next_possible_statuses" => [400]
        ],
        400 => [
            "code" => 400,
            "color_class" => 'label-warning',
            ...
            "description" => [
                "uz" => "Buyurtma ichki tashish jarayonida.",
                "ru" => "Отправление находится во внутренней перевозке.",
                "en" => "The shipment is in internal transport."
            ],
            "next_possible_statuses" => [500]
        ],
        500 => [
            "code" => 500,
            "color_class" => 'label-warning',
            "name" => [
                ...
                "ru" => "В РЦ",
                "en" => "At the distribution center"
            ],
            "description" => [
                "uz" => "Jo‘natma saralash markazida qayta ishlanmoqda.",
                "ru" => "Отправление обрабатывается в сортировочном центре.",
                "en" => "The shipment is being processed at the sorting center."
            ],
            "next_possible_statuses" => [600]
        ],
        600 => [
            "code" => 600,
            "color_class" => 'label-warning',
            ...
            "description" => [
                "uz" => "Jo‘natma logistika qopiga joylandi.",
                "ru" => "Отправление помещено в логистический мешок.",
                "en" => "The shipment has been placed into a logistics bag."
            ],
            "next_possible_statuses" => [700]
        ],
        700 => [
            "code" => 700,
            ...
            "description" => [
                "uz" => "Jo‘natma tashuv yo‘lida.",
                "ru" => "Отправление находится в перевозке.",
                "en" => "The shipment is in transit."
            ],
            "next_possible_statuses" => [800]
        ],
        800 => [
            "code" => 800,
            "color_class" => 'label-warning',
            ...
            "description" => [
                "uz" => "Jo‘natma yetkazib berish ofisiga yetib keldi.",
                "ru" => "Отправление прибыло в офис доставки.",
                "en" => "The shipment has arrived at the delivery office."
            ],
            "next_possible_statuses" => [900, 1000, 1100]
        ],
        1100 => [
            "code" => 1100,
            "color_class" => 'label-warning',
            "name" => [
                ...
                "en" => "Courier delivering"
            ],
            "description" => [
                "uz" => "Kuryer jo‘natmani qabul qilib, manzilga yetkazmoqda.",
                "ru" => "Курьер принял отправление и доставляет получателю.",
                "en" => "The courier accepted the shipment and is delivering it to the recipient."
            ],
            "next_possible_statuses" => [1200]
        ],
        1200 => [
            "code" => 1200,
            ...
            "description" => [
                "uz" => "Jo‘natma muvaffaqiyatli yetkazib berildi.",
                "ru" => "Отправление успешно доставлено.",
                "en" => "The shipment has been delivered successfully."
            ],
        ...
        1400 => [
            ...
            "description" => [
                "uz" => "Buyurtmaning amal qilish moduli tugagan.",
                "ru" => "Срок действия заказа истек.",
                "en" => "The order validity period has expired."
            ],
            "next_possible_statuses" => []
        ]
    ];

    public const array LANGUAGES = ['uz', 'ru', 'en'];
}