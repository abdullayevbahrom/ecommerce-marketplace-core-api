...
/**
 * AdvantagesSearch represents the model behind the search form of `app\models\advantages\Advantages`.
 */
class AdvantagesSearch extends Advantages
{
    ...
    public function rules()
    {
        return [
            ...
            [['name_ru', 'name_uz', 'name_en', 'description_ru', 'description_uz', 'description_en', 'date'], 'safe'],
        ];
    }
