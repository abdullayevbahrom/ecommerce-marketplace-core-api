...
!function(e, t) {
    ...
    w.extend = w.fn.extend = function() {
        ...
        s--); s < u; s++)
            if (null != (e = arguments[s]))
                for (t in e)
                    r = e[t],
                    "__proto__" !== t && a !== r && (l && r && (w.isPlainObject(r) || (o = Array.isArray(r))) ? (n = a[t],
                    i = o && !Array.isArray(n) ? [] : o || w.isPlainObject(n) ? n : {},
                    o = !1,
                    a[t] = w.extend(l, i, r)) : void 0 !== r && (a[t] = r));
        return a
    }
    ,
    w.extend({
    ...
    var C = function(e) {
        var t, n, r, o, i, a, s, u, l, c, f, d, p, h, g, m, y, v, x, b = "sizzle" + 1 * new Date, w = e.document, T = 0, C = 0, E = ue(), k = ue(), S = ue(), A = ue(), N = function(e, t) {
            return e === t && (f = !0),
            0
        }, j = {}.hasOwnProperty, D = [], L = D.pop, q = D.push, H = D.push, I = D.slice, O = function(e, t) {
            for (var n = 0, r = e.length; n < r; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, R = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", P = "[\\x20\\t\\r\\n\\f]", B = "(?:\\\\[\\da-fA-F]{1,6}" + P + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", M = "\\[" + P + "*(" + B + ")(?:" + P + "*([*^$|!~]?=)" + P + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + B + "))|)" + P + "*\\]", $ = ":(" + B + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + M + ")*)|.*)\\)|)", W = new RegExp(P + "+","g"), F = new RegExp("^" + P + "+|((?:^|[^\\\\])(?:\\\\.)*)" + P + "+$","g"), _ = new RegExp("^" + P + "*," + P + "*"), U = new RegExp("^" + P + "*([>+~]|" + P + ")" + P + "*"), z = new RegExp(P + "|>"), X = new RegExp($), V = new RegExp("^" + B + "$"), G = {
            ID: new RegExp("^#(" + B + ")"),
            CLASS: new RegExp("^\\.(" + B + ")"),
            TAG: new RegExp("^(" + B + "|[*])"),
            ATTR: new RegExp("^" + M),
        ...
        }, Y = /HTML$/i, Q = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}" + P + "?|\\\\([^\\r\\n\\f])","g"), ne = function(e, t) {
        ...
        try {
            H.apply(D = I.call(w.childNodes), w.childNodes),
        ...
        function se(e, t, r, o) {
            var i, s, l, c, f, h, y, v = t && t.ownerDocument, w = t ? t.nodeType : 9;
            if (r = r || [],
            ...
            g)) {
                    ...
                    if (i = f[1]) {
                        if (9 === w) {
                            ...
                            if (l.id === i)
                                return r.push(l),
                                r
                        } else if (v && (l = v.getElementById(i)) && x(t, l) && l.id === i)
                            return r.push(l),
                            r
                    } else {
                        if (f[2])
                ...
                if (n.qsa && !A[e + " "] && (!m || !m.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    try {
                        return H.apply(r, v.querySelectorAll(y)),
                        r
                    } catch (t) {
                        A(e, !0)
                    } finally {
        ...
        d = se.setDocument = function(e) {
            ...
            (n.qsa = K.test(p.querySelectorAll)) && (ce((function(e) {
                ...
                e.appendChild(t),
                e.querySelectorAll("[name='']").length || m.push("\\[" + P + "*name" + P + "*=" + P + "*(?:''|\"\")"),
            ...
            filter: {
                ...
                ATTR: function(e, t, n) {
                    return function(r) {
                        var o = se.attr(r, e);
                        return null == o ? "!=" === t : !t || (o += "",
                        "=" === t ? o === n : "!=" === t ? o !== n : "^=" === t ? n && 0 === o.indexOf(n) : "*=" === t ? n && -1 < o.indexOf(n) : "$=" === t ? n && o.slice(-n.length) === n : "~=" === t ? -1 < (" " + o.replace(W, " ") + " ").indexOf(n) : "|=" === t && (o === n || o.slice(0, n.length + 1) === n + "-"))
                    }
                },
                CHILD: function(e, t, n, r, o) {
                    ...
                    : function(t, n, u) {
                        var l, c, f, d, p, h, g = i !== a ? "nextSibling" : "previousSibling", m = t.parentNode, y = s && t.nodeName.toLowerCase(), v = !u && !s, x = !1;
                        if (m) {
                            if (i) {
                                for (; g; ) {
                                    for (d = t; d = d[g]; )
                            ...
                            !1 === x)
                                for (; (d = ++p && d && d[g] || (x = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== y : 1 !== d.nodeType) || !++x || (v && ((c = (f = d[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [T, x]),
                                d !== t)); )
                                    ;
            ...
            le((function(i, a, s, u) {
                var l, c, f, d = [], p = [], h = a.length, g = i || function(e, t, n) {
                    for (var r = 0, o = t.length; r < o; r++)
                        se(e, t[r], n);
                    return n
                }(t || "*", s.nodeType ? [s] : s, []), m = !e || !i && t ? g : Te(g, d, e, s, u), y = n ? o || (i ? e : h || r) ? [] : a : m;
                if (n && n(m, y, s, u),
                r)
                    for (l = Te(y, p),
                    r(l, [], s, u),
                ...
                if (i) {
                    if (o || e) {
                        ...
                        for (c = y.length; c--; )
                            (f = y[c]) && -1 < (l = o ? O(i, f) : d[c]) && (i[l] = !(a[l] = f))
                    }
                } else
                    y = Te(y === a ? y.splice(h, y.length) : y),
                    o ? o(null, a, y, u) : H.apply(a, y)
            }
            ))
        }
        function Ee(e) {
                ...
                if (n = r.relative[e[u].type])
                    ...
                    if ((n = r.filter[e[u].type].apply(null, e[u].matches))[b]) {
                        ...
                        return Ce(1 < u && we(d), 1 < u && xe(e.slice(0, u - 1).concat({
                            value: " " === e[u - 2].type ? "*" : ""
                        })).replace(F, "$1"), n, u < o && Ee(e.slice(u, o)), o < i && Ee(e = e.slice(o)), o < i && xe(e))
                    }
                    d.push(n)
                }
            return we(d)
        ...
        s = se.compile = function(e, t) {
            var n, o, i, s, u, c, f = [], h = [], m = S[e + " "];
            if (!m) {
                for (t || (t = a(e)),
                n = t.length; n--; )
                    (m = Ee(t[n]))[b] ? f.push(m) : h.push(m);
                (m = S(e, (o = h,
                s = 0 < (i = f).length,
                u = 0 < o.length,
                c = function(e, t, n, a, c) {
                    var f, h, m, y = 0, v = "0", x = e && [], b = [], w = l, C = e || u && r.find.TAG("*", c), E = T += null == w ? 1 : Math.random() || .1, k = C.length;
                    for (c && (l = t == p || t || c); v !== k && null != (f = C[v]); v++) {
                        if (u && f) {
                            for (h = 0,
        ...
        u = se.select = function(e, t, n, o) {
            ...
            return (d || s(e, p))(o, t, !g, n, !t || ee.test(e) && ye(t.parentNode) || t),
            n
        }
        ,
    ...
    w.each({
        ...
        w.fn[e] = function(n, r) {
            ...
            1 < this.length && (H[e] || w.uniqueSort(o),
            q.test(e) && o.reverse()),
            this.pushStack(o)
        }
    }
    ...
    w.extend({
                            ...
                            var s = this
                              ...
                              , l = function() {
                                ...
                                if (!(t < i)) {
                                    ...
                                    h(l) ? o ? l.call(e, a(i, n, R, o), a(i, n, P, o)) : (i++,
                                    l.call(e, a(i, n, R, o), a(i, n, P, o), a(i, n, R, n.notifyWith))) : (r !== R && (s = void 0,
                                    u = [e]),
                                    (o || n.resolveWith)(s, u))
                                }
                            }
        ...
        when: function(e) {
            ...
            if (t <= 1 && (B(e, a.done(s(n)).resolve, a.reject, !t),
    ...
    w.extend({
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --w.readyWait : w.isReady) || (w.isReady = !0) !== e && 0 < --w.readyWait || $.resolveWith(m, [w])
        }
    }),
    w.ready.then = $.then,
    ...
    w.event = {
        ...
        dispatch: function(e) {
            var t, n, r, o, i, a, s = new Array(arguments.length), u = w.event.fix(e), l = (Y.get(this, "events") || Object.create(null))[u.type] || [], c = w.event.special[u.type] || {};
            for (s[0] = u,
            ...
            !c.preDispatch || !1 !== c.preDispatch.call(this, u)) {
                ...
                t = 0; (o = a[t++]) && !u.isPropagationStopped(); )
                    ...
                    n = 0; (i = o.handlers[n++]) && !u.isImmediatePropagationStopped(); )
                        ...
                        u.data = i.data,
                        void 0 !== (r = ((w.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, s)) && !1 === (u.result = r) && (u.preventDefault(),
                        u.stopPropagation()));
            ...
            if (u && l.nodeType && !("click" === e.type && 1 <= e.button))
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
                        ...
                        a = {},
                        n = 0; n < u; n++)
                            void 0 === a[o = (r = t[n]).selector + " "] && (a[o] = r.needsContext ? -1 < w(o, this).index(l) : w.find(o, this, null, [l]).length),
                            a[o] && i.push(r);
                        i.length && s.push({
                            elem: l,
                            handlers: i
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && A(t, "input") && ke(t, "click", we),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
    ...
    function He(e, t, n, r) {
        t = i(t);
        var o, a, s, u, l, c, f = 0, d = e.length, g = d - 1, m = t[0], y = h(m);
        if (y || 1 < d && "string" == typeof m && !p.checkClone && Ae.test(m))
        ...
        if (d && (a = (o = xe(t, e[0].ownerDocument, !1, e, r)).firstChild,
        1 === o.childNodes.length && (o = a),
        a || r)) {
            for (u = (s = w.map(me(o, "script"), De)).length; f < d; f++)
                l = o,
                f !== g && (l = w.clone(l, !0, !0),
                u && w.merge(s, me(l, "script"))),
                n.call(e[f], l, f);
            if (u)
                ...
                f = 0; f < u; f++)
                    ...
                    }, c) : v(l.textContent.replace(Ne, ""), l, c))
        }
        return e
    }
    function Ie(e, t, n) {
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    ...
                    qe(e, c);
            return 0 < (a = me(c, "script")).length && ye(a, !f && me(e, "script")),
            c
        },
    ...
    function Me(e, t, n) {
        ...
        return (n = n || Re(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || oe(e) || (a = w.style(e, t)),
        !p.pixelBoxStyles() && Oe.test(a) && Be.test(t) && (r = s.width,
        o = s.minWidth,
        i = s.maxWidth,
    ...
    var We = ["Webkit", "Moz", "ms"]
      ...
      , _e = {};
    function Ue(e) {
        return w.cssProps[e] || _e[e] || (e in Fe ? e : _e[e] = function(e) {
    ...
    function Qe(e, t, n, r, o, i) {
        ...
        if (n === (r ? "border" : "content"))
            return 0;
        for (; a < 4; a += 2)
            "margin" === n && (u += w.css(e, n + ne[a], !0, o)),
            r ? ("content" === n && (u -= w.css(e, "padding" + ne[a], !0, o)),
            "margin" !== n && (u -= w.css(e, "border" + ne[a] + "Width", !0, o))) : (u += w.css(e, "padding" + ne[a], !0, o),
            "padding" !== n ? u += w.css(e, "border" + ne[a] + "Width", !0, o) : s += w.css(e, "border" + ne[a] + "Width", !0, o));
    ...
    w.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, i, a, s = X(t), u = Xe.test(t), l = e.style;
                if (u || (t = Ue(s)),
                ...
                i = "number"),
                null != n && n == n && ("number" !== i || u || (n += o && o[3] || (w.cssNumber[s] ? "" : "px")),
    ...
    w.each(["height", "width"], (function(e, t) {
        w.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return !ze.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Je(e, t, r) : Pe(e, Ve, (function() {
                        return Je(e, t, r)
                    }
                    ))
            },
            set: function(e, n, r) {
                var o, i = Re(e), a = !p.scrollboxSize() && "absolute" === i.position, s = (a || r) && "border-box" === w.css(e, "boxSizing", !1, i), u = r ? Qe(e, t, r, s, i) : 0;
                return s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(i[t]) - Qe(e, t, "border", !1, i) - .5)),
    ...
    w.cssHooks.marginLeft = $e(p.reliableMarginLeft, (function(e, t) {
        if (t)
            return (parseFloat(Me(e, "marginLeft")) || e.getBoundingClientRect().left - Pe(e, {
                marginLeft: 0
            }, (function() {
    ...
    function lt(e, t, n) {
        var r, o, i = 0, a = lt.prefilters.length, s = w.Deferred().always((function() {
            delete u.elem
        }
        )), u = function() {
            if (o)
                return !1;
            for (var t = Ze || at(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), i = 0, a = l.tweens.length; i < a; i++)
                l.tweens[i].run(r);
    ...
    w.Animation = w.extend(lt, {
        ...
        prefilters: [function(e, t, n) {
            var r, o, i, a, s, u, l, c, f = "width"in t || "height"in t, d = this, p = {}, h = e.style, g = e.nodeType && ae(e), m = Y.get(e, "fxshow");
            ...
            if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(p))
                ...
                c = w.css(e, "display"),
                le([e]))),
                ("inline" === c || "inline-block" === c && null != l) && "none" === w.css(e, "float") && (u || (d.done((function() {
                    h.display = l
                }
                )),
                null == l && (c = h.display,
                ...
                u = !1,
                p)
                    u || (m ? "hidden"in m && (g = m.hidden) : m = Y.access(e, "fxshow", {
                        display: l
                    }),
                    i && (m.hidden = !g),
                    g && le([e], !0),
    ...
    w.extend(w.event, {
        trigger: function(t, n, r, o) {
            var i, a, s, u, l, f, d, p, y = [r || m], v = c.call(t, "type") ? t.type : t, x = c.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = p = s = r = r || m,
            ...
            o || !d.trigger || !1 !== d.trigger.apply(r, n))) {
                if (!o && !d.noBubble && !g(r)) {
                    ...
                    vt.test(u + v) || (a = a.parentNode); a; a = a.parentNode)
                        y.push(a),
                        s = a;
                ...
                for (i = 0; (a = y[i++]) && !t.isPropagationStopped(); )
                    p = a,
                    t.type = 1 < i ? u : d.bindType || v,
                    (f = (Y.get(a, "events") || Object.create(null))[t.type] && Y.get(a, "handle")) && f.apply(a, n),
                    (f = l && a[l]) && f.apply && V(a) && (t.result = f.apply(a, n),
                    !1 === t.result && t.preventDefault());
                return t.type = v,
                o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(y.pop(), n) || !V(r) || l && h(r[v]) && !g(r) && ((s = r[l]) && (r[l] = null),
                w.event.triggered = v,
    ...
    function At(e, t, n, r) {
        ...
        if (Array.isArray(t))
            w.each(t, (function(t, o) {
                n || Ct.test(e) ? r(e, o) : At(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, r)
            }
            ));
    ...
    w.fn.extend({
        ...
        serializeArray: function() {
            return this.map((function() {
                ...
                var e = this.type;
                return this.name && !w(this).is(":disabled") && St.test(this.nodeName) && !kt.test(e) && (this.checked || !de.test(e))
            }
            )).map((function(e, t) {
                var n = w(this).val();
    ...
    function Bt(e) {
        return function(t, n) {
            "string" != typeof t && (n = t,
            t = "*");
            var r, o = 0, i = t.toLowerCase().match(O) || [];
            if (h(n))
                for (; r = i[o++]; )
                    "+" === r[0] ? (r = r.slice(1) || "*",
    ...
    w.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var r, o, i, a, s, u, l, c, f, d, p = w.ajaxSetup({}, n), h = p.context || p, g = p.context && (h.nodeType || h.jquery) ? w(h) : w.event, y = w.Deferred(), v = w.Callbacks("once memory"), x = p.statusCode || {}, b = {}, T = {}, C = "canceled", E = {
                readyState: 0,
            ...
            if (y.promise(E),
            p.url = ((t || p.url || bt.href) + "").replace(Ht, bt.protocol + "//"),
            ...
            l)
                return E;
            for (f in (c = w.event && p.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
            p.type = p.type.toUpperCase(),
            p.hasContent = !qt.test(p.type),
            o = p.url.replace(jt, ""),
            p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Nt, "+")) : (d = p.url.slice(o.length),
            p.data && (p.processData || "string" == typeof p.data) && (o += (Tt.test(o) ? "&" : "?") + p.data,
            delete p.data),
            !1 === p.cache && (o = o.replace(Dt, "$1"),
            d = (Tt.test(o) ? "&" : "?") + "_=" + wt.guid++ + d),
            p.url = o + d),
            p.ifModified && (w.lastModified[o] && E.setRequestHeader("If-Modified-Since", w.lastModified[o]),
            ...
            function k(t, n, a, u) {
                ...
                !f && -1 < w.inArray("script", p.dataTypes) && w.inArray("json", p.dataTypes) < 0 && (p.converters["text script"] = function() {}
                ),
                b = function(e, t, n, r) {
                ...
                f ? (p.ifModified && ((T = E.getResponseHeader("Last-Modified")) && (w.lastModified[o] = T),
                ...
                E.status = t,
                E.statusText = (n || C) + "",
                f ? y.resolveWith(h, [d, C, E]) : y.rejectWith(h, [E, C, m]),
                E.statusCode(x),
                x = void 0,
                c && g.trigger(f ? "ajaxSuccess" : "ajaxError", [E, p, f ? d : m]),
                v.fireWith(h, [E, C]),
    ...
    w.parseHTML = function(e, t, n) {
        ...
        i = !n && [],
        (o = N.exec(e)) ? [t.createElement(o[1])] : (o = xe([e], t, i),
...
var loadImage = function (event) {
  ...
  div.classList.add('p_'+uniqid)
  var btn = document.createElement("button");
  btn.className = "fas fa-times photo__delete";
  btn.addEventListener("click", function(e) {
      e.target.parentNode.remove();
      $(".photo__col__input label").show()
      $(".fa-camera").remove()
      $(".photo__col__input").css("background", "#84c7ae")
  });
  entry.src = firstname
  ...
  div.appendChild(btn)
    ...
    $('.photo__col__input').hide();
      $('#demos').prepend('<div class="photo__col__input t_'+uniqid+'"><label for="file-input" class="photo__label">+</label><input multiple name="Ads[imageFiles][]" onchange="loadImage(event)" type="file" id="file-input" class="photo__input"/></div>');
};

// accordian toggle
function myFunction(event) {
  var x = document.getElementById("myDIV101");
  var y = document.getElementById("myDIV100");
...
function myFunction1() {
  ...
  var y = document.getElementById("myDIV101");
  if (x.style.display === "none" || y.style.display === "block") {
    x.style.display = "block";
    y.style.display = "none";
  } 
...
var images_modal1 = document.getElementById("modal1")
  , images_modal2 = document.getElementById("modal2")
  , images_modal3 = document.getElementById("modal3");
window.addEventListener("click", (function(e) {
    e.target == images_modal1 && (images_modal1.style.display = "none")
}
)),
window.addEventListener("click", (function(e) {
    e.target == images_modal2 && (images_modal2.style.display = "none")
}
)),
window.addEventListener("click", (function(e) {
    e.target == images_modal3 && (images_modal3.style.display = "none")
}
));
var images_modal = document.getElementById("dropdown");
window.addEventListener("click", (function(e) {
    e.target == images_modal && (images_modal.style.display = "none")
}
)),
...
$(".radioContainer").on("click",(function(e){
    ...
    $(this).find('label').attr('style', 'background: #038992;border-radius: 8px;color: #fff;')
}
))
function acc1() {
    const accordion1 = document.getElementById('accordion1');
    const aicon1open = document.getElementById('aicon1open');
    accordion1.classList.toggle('accordion1__block');
    aicon1open.classList.toggle('accordion1__transform');
  }
  function acc2() {
    const accordion2 = document.getElementById('accordion2');
    const aicon2open = document.getElementById('aicon2open');
    accordion2.classList.toggle('accordion1__block');
    aicon2open.classList.toggle('accordion1__transform');
  }
  function acc3() {
    const accordion3 = document.getElementById('accordion3');
    const aicon3open = document.getElementById('aicon3open');
    accordion3.classList.toggle('accordion1__block');
    aicon3open.classList.toggle('accordion1__transform');
  }
  function acc4() {
    const accordion4 = document.getElementById('accordion4');
    const aicon4open = document.getElementById('aicon4open');
    accordion4.classList.toggle('accordion1__block');
    aicon4open.classList.toggle('accordion1__transform');
  }
  function acc5() {
    const accordion5 = document.getElementById('accordion5');
    const aicon5open = document.getElementById('aicon5open');
    accordion5.classList.toggle('accordion1__block');
    aicon5open.classList.toggle('accordion1__transform');
  }
  function acc6() {
    const accordion6 = document.getElementById('accordion6');
    const aicon6open = document.getElementById('aicon6open');
    accordion6.classList.toggle('accordion1__block');
    aicon6open.classList.toggle('accordion1__transform');
  }
...
function countChar(val) {
  ...
  if(len > 10 && len <= 1000){
      ...
      $(".text__box p").html("Описание должно быть не короче 10 знаков")
      $("#charNum").text(0 + len)
  }
  else if (len >= 1000) {
...
const targetDiv = document.getElementById("rubric__box");
const btn = document.getElementById("rubric__button");
const all = document.getElementById("rubric__all");
btn.onclick = function () {
  if (targetDiv.style.display == "block") {
    targetDiv.style.display = "none";
    btn.classList.remove("select__select2");
  } else {
    targetDiv.style.display = "block";
    btn.classList.add("select__select2");
    all.classList.add("rubric__all");
  }
};
all.onclick = function () {
  all.classList.remove("rubric__all");
  targetDiv.style.display = "none";
  btn.classList.remove("select__select2");
}