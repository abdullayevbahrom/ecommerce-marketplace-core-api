...
document.querySelector(".increment__text").innerText = document.querySelector(".textarea__message textarea").textLength
  var n = [],
...
var complain1 = document.getElementById("modalComplain");
// When the user clicks anywhere outside of the modal, close it

window.addEventListener('click', function(e){
  // close dropdown when clicked outside
  if (!self.$el.contains(e.target)){
    complain1.style.display = "none"
    console.log("Name");
  } 
})
function modalComplain1() {
  var y = document.getElementById("modalComplain");
...
function complainClose1() {
  var z = document.getElementById("modalComplain");
