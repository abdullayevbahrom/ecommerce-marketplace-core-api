            ...
            <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data'], 'id' => 'form-profile']);?>
                <div class="box-body">
                    ...
                    <div class="lang-block lang-block-ru">
                        <?=$form->field($model, 'name_ru', ['template'=>'{label}<div class="input-group"><span class="input-group-addon"><i class="fa fa-pencil"></i></span>{input}</div>{error}'])->textInput()->input('text')->label('Название (RU) <span class="error_field">*</span>');?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <?php if ($model->file) {?>
                                ...
                                <br/><br/>
                                <a href="<?=Yii::$app->urlManager->createUrl(['/shop/default/remove-file', 'id'=>$model->file->id])?>" class="remove-object btn btn-sm btn-danger"><i class="fa fa-remove"></i> Удалить файл</a>
                                <br/><br/>
                            <?php }?>
                        </div>
                    </div>    
