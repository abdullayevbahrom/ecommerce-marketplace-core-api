                ...
                <div class="box-body">
                    <div id="block-form">
                        <div class="block-block">
                            <div class="row">
                                <div class="col-sm-4">
                                    <?=$form->field($model, 'names_ru[]')->textInput()->input('text')->label('<img src="/assets_files/images/languages/ru.png" width="25"> Русский');?>
                                </div>
                                <div class="col-sm-4">
                                    <?=$form->field($model, 'names_uz[]')->textInput()->input('text')->label('<img src="/assets_files/images/languages/uz.png" width="25"> Узбекский');?>
                                </div>
                                <div class="col-sm-4">
                                    <?=$form->field($model, 'names_en[]')->textInput()->input('text')->label('<img src="/assets_files/images/languages/en.png" width="25"> Английский');?>
                                </div>
                            </div>
                        </div>
                    </div>
