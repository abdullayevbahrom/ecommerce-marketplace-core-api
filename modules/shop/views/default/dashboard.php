        ...
        <div class="row">
            <div class="col-lg-4 col-xs-6">
                <div class="small-box bg-green">
                    ...
                    <a href="<?=Yii::$app->urlManager->createUrl(['/shop/product'])?>" class="small-box-footer">Посмотреть <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-xs-6">
                <div class="small-box bg-yellow">
                    ...
                    <a href="<?=Yii::$app->urlManager->createUrl(['/shop/user'])?>" class="small-box-footer">Посмотреть <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-xs-6">
                <div class="small-box bg-aqua">
                    ...
                    <a href="<?=Yii::$app->urlManager->createUrl(['/shop/order'])?>" class="small-box-footer">Посмотреть <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?=Yii::$app->urlManager->createUrl(['/shop/default/dashboard', 'type'=>'week'])?>">За неделю</a></li>
                        <li><a href="<?=Yii::$app->urlManager->createUrl(['/shop/default/dashboard', 'type'=>'month'])?>">За месяц</a></li>
                        <li><a href="<?=Yii::$app->urlManager->createUrl(['/shop/default/dashboard', 'type'=>'hyear'])?>">За пол года</a></li>
                        <li><a href="<?=Yii::$app->urlManager->createUrl(['/shop/default/dashboard', 'type'=>'year'])?>">За год</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model, $key, $index, $column) {
                                return ($model->user) ? '<a href="'.Yii::$app->urlManager->createUrl(['/shop/user/view', 'id'=>$model->user->id]).'">'.$model->user->name.'</a>' : 'Не указано';
                            },
                        ],
                        [
                            'attribute'=>'price',
