                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="<?=Yii::$app->urlManager->createUrl(['/shop/product/create', 'id'=>$model->id]);?>" class="btn btn-warning btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php } elseif ($model->status == 2) {?>
                                                ...
                                                <small class="text-muted">(Обратитесь к администратору для разблокировки)</small>
                                            <?php } else {?>
                                    ...
                                    <div class="col-md-2 col-sm-3 col-xs-4" style="margin-bottom: 15px;">
                                        <div class="thumbnail">
                                            <a href="<?=$photo->getPhoto('product');?>" target="_blank">
                                                <img src="<?=$photo->getPhoto('product');?>" alt="Фото товара" class="img-responsive" style="height: 120px; object-fit: cover;">
                                            </a>
                                        </div>
                                    </div>
                                <?php }?>
                            ...
                            <div class="box-body">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $model->stock ? Html::encode($model->stock->name_ru) : '<span class="text-muted">Не указан</span>' ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($model->products as $product) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?=Yii::$app->urlManager->createUrl(['/shop/product/view', 'id'=>$product->id]);?>" target="_blank">
                                                        <?=$product->name_ru;?>
                                                    </a>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-xs">
                                                        <a href="<?=Yii::$app->urlManager->createUrl(['/shop/product/view', 'id'=>$product->id]);?>" class="btn btn-info btn-xs" title="Просмотр">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a href="<?=Yii::$app->urlManager->createUrl(['/shop/product/update', 'id'=>$product->id]);?>" class="btn btn-warning btn-xs" title="Редактировать">
