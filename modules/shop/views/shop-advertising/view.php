<?php
use app\widgets\admin_shop_advertising_menu\AdminShopAdvertisingMenu;
use app\widgets\admin_language_tab\AdminLanguageTab;

$this->title = $model ? $model->name_ru : 'Реклама';
...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php if (Yii::$app->session->hasFlash('shop_advertising_saved')) {?>
            <div class="callout callout-success text-center">
                <?=Yii::$app->session->getFlash('shop_advertising_saved');?>
            </div>
        <?php }?>
        <?php if (Yii::$app->session->hasFlash('shop_advertising_locked')) {?>
            <div class="callout callout-success text-center">
                <?=Yii::$app->session->getFlash('shop_advertising_locked');?>
            </div>
        <?php }?>
        <div class="row">
            <div class="col-sm-3">
                <?=AdminShopAdvertisingMenu::widget();?>
            </div>
            <div class="col-sm-9">
