        ...
        <div class="box box-info color-palette-box">
            <div class="box-header with-border">
                <div class="box-title pull-right" style="font-size: 14px">
                    <a href="<?=Yii::$app->urlManager->createUrl(['/shop/shop-advertising/create'])?>" class="btn btn-primary">
            ...
            <div class="box-body" id="item-block">
                <?= GridView::widget([
                    ...
                    'summary' => "Страница {begin} - {end} из {totalCount} рекламы<br/><br/>",
                    'emptyText' => 'Рекламы нет',
                    'rowOptions' => function ($model, $index, $widget, $grid) {
                        return [
                            'id' => $model['id'],
                            'url' => Yii::$app->urlManager->createUrl('/shop/shop-advertising/view').'?id='.$model['id']
                        ];
                    },
                    'tableOptions' => [
                        ...
                        [
                            ...
                            'buttons' => [
                                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['/shop/shop-advertising/create', 'id'=>$model->id]), ['class'=>'btn btn-warning']);
                                },
                                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span>', Yii::$app->urlManager->createUrl(['/shop/shop-advertising/remove', 'id'=>$model->id]), ['class'=>'btn btn-danger remove-object']);
                                }
                            ],
                        ]
                    ],
