                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="<?=Yii::$app->urlManager->createUrl(['/logist/logist/tariff', 'id'=>Yii::$app->request->get('id')]);?>">Список регионов</a></li>
                                    <li><a href="<?=Yii::$app->urlManager->createUrl(['/logist/logist/tariff-create', 'id'=>Yii::$app->request->get('id')]);?>">Добавить тариф</a></li>
                                    <li><a href="<?=Yii::$app->urlManager->createUrl(['/logist/logist/tariff-create', 'id'=>Yii::$app->request->get('id'), 'tariff_id'=>$model->id]);?>">Редактировать</a></li>
                                    <li><a href="<?=Yii::$app->urlManager->createUrl(['/logist/logist/tariff-remove', 'id'=>Yii::$app->request->get('id'), 'tariff_id'=>$model->id]);?>" class="remove-object">Удалить</a></li>
                                </ul>
                            </div>
                        </div>
                        Регион
