...
$this->title = 'Добавить логистическую компанию';
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="row">
                                <div class="col-xs-6"> 
                                    <?=$form->field($model, 'imageFiles[]')->fileInput(['class'=>'file-upload-ajax'])->label('Логотип'); ?>
                                </div>
                                <div class="col-xs-6">
                        ...
                        <div class="col-sm-7">
                            ...
                            <?=$form->field($model, 'contact_phone')->textInput()->input('text', ['class'=>'form-control sms-phone'])->label('Контактный номер телефона');?>
                        </div>
                    </div>
                </div>
            </div>
