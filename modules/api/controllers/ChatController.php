...
class ChatController extends Controller {
    ...
    public function actionUsers() {
        ...
        if (Yii::$app->request->get('type') == 'archive') {
        ...
        } else if (Yii::$app->request->get('type') == 'important') {
        ...
        } else if (Yii::$app->request->get('type') == 'block') {
        ...
        if ($model) {
            foreach ($model as $k => $v) {
                if ((Yii::$app->request->get('type') == 'unreaded') && ($new_messages[$k] == 0)) continue;
                if ($type_user = Yii::$app->request->get('type_user')) {
                    if ($v->type != $type_user) {
                        continue;
                    }
                }
