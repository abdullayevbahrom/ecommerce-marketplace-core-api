        ...
        <div class="box box-info color-palette-box">
            <div class="box-header with-border">
                <div class="box-title pull-right" style="font-size: 14px">
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/delivery/create'])?>" class="btn btn-primary">
            ...
            <div class="box-body" id="item-block">
                <?= GridView::widget([
                    ...
                    'summary' => "Page {begin} - {end} of {totalCount} shipping methods<br/><br/>",
                    'emptyText' => 'No delivery methods',
                    'rowOptions' => function ($model, $index, $widget, $grid) {
                        return [
                            'id' => $model['id'],
                            'url' => Yii::$app->urlManager->createUrl('/admin/delivery/view').'?id='.$model['id']
                        ];
                    },
                    'tableOptions' => [
                        ...
                        [
                            ...
                            'buttons' => [
                                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['/admin/delivery/create', 'id'=>$model->id]), ['class'=>'btn btn-warning']);
                                },
                                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span>', Yii::$app->urlManager->createUrl(['/admin/delivery/remove', 'id'=>$model->id]), ['class'=>'btn btn-danger remove-object']);
                                }
                            ],
                        ]
                    ],
