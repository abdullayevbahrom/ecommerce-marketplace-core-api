...
<div class="box box-info color-palette-box">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-6">
                <?=$form->field($model, 'name_ru')->textInput()->label('Name (Russian): <span class="error_field">*</span>');?>
            </div>
            <div class="col-sm-6">
                <?=$form->field($model, 'name_en')->textInput()->label('Name (English):');?>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
                <?=$form->field($model, 'name_uz')->textInput()->label('Name (Uzbek):');?>
            </div>
            <div class="col-sm-6">
                <?=$form->field($model, 'sort')->textInput()->label('Sort Order:');?>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <?php if ($model->image) {?>
                    ...
                    <br><br>
                <?php }?>
                <?=$form->field($model, 'imageFiles[]')->fileInput(['multiple' => true, 'accept' => 'image/*'])->label('Images:');?>
            </div>
        </div>
    </div>
</div>
