...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php if (Yii::$app->session->hasFlash('stock_removed')) {?>
            <div class="callout callout-success text-center">
                <?=Yii::$app->session->getFlash('stock_removed');?>
            </div>
        <?php }?>
        <div class="box box-info color-palette-box">
            <div class="box-header with-border">
                <div class="pull-right">
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/stock/create'])?>" class="btn btn-primary">
                        <i class="glyphicon glyphicon-plus"></i> Add warehouse
                    </a>
                </div>
                <div id="action-links">
            ...
            <div class="box-body" id="item-block">
                <?= GridView::widget([
                    ...
                    'summary' => "Page {begin} - {end} of {totalCount} warehouse<br/><br/>",
                    'emptyText' => 'No warehouses',
                    'rowOptions' => function ($model, $index, $widget, $grid) {
                        return [
                            'id' => $model['id'],
                            'url' => Yii::$app->urlManager->createUrl('/admin/stock/view').'?id='.$model['id']
                        ];
                    },
                    'tableOptions' => [
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'label'=>'<i class="fa fa-sort"></i> Products',
                            'encodeLabel' => false,
                            'contentOptions' => [
                                'style' => 'width:100px'
                            ],
                            'value' => function ($model, $key, $index, $column) {
                                return ($model->products) ? count($model->products) : 0;
                            },
                        ],
                        [
                            'attribute'=>'status',
                        ...
                        [
                            ...
                            'buttons' => [
                                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['/admin/stock/create', 'id'=>$model->id]), ['class'=>'btn btn-warning']);
                                },
                                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span>', Yii::$app->urlManager->createUrl(['/admin/stock/remove', 'id'=>$model->id]), ['class'=>'btn btn-danger remove-object']);
                                }
                            ],
                        ]
                    ],
