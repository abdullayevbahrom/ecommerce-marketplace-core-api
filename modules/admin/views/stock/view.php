                                ...
                                <div class="col-sm-6">
                                    <table class="table table-condensed">
                                        <?php if ($model->bts_region_id) {?>
                                            <tr>
                                                <td><i class="fa fa-globe text-muted"></i> <strong>Region:</strong></td>
                                                <td>
                                                    <div class="lang-block lang-block-ru">
                                            ...
                                            <tr>
                                                <td><strong>Region BTS ID:</strong></td>
                                        ...
                                        <?php if ($model->bts_city_id) {?>
                                            <tr>
                                                <td><i class="fa fa-building text-muted"></i> <strong>City:</strong></td>
                                                <td>
                                                    <div class="lang-block lang-block-ru">
                                            ...
                                            <tr>
                                                <td><strong>City BTS ID:</strong></td>
                                ...
                                <div class="col-sm-6">
                                    <?php if ($model->address) {?>
                                        <div class="form-group">
                                            <label><i class="fa fa-home text-muted"></i> <strong>Address:</strong></label>
                                    ...
                                    <div class="form-group">
                                        <label><i class="fa fa-map-o text-muted"></i> <strong>Full Address:</strong></label>
                                        <div class="well well-sm">
                                            <div class="lang-block lang-block-ru">
                                                <?= $model->getFullAddress('ru') ?: 'Not specified' ?>
                                            </div>
                                            <div class="lang-block lang-block-en">
                                                <?= $model->getFullAddress('en') ?: 'Not specified' ?>
                                            </div>
                                            <div class="lang-block lang-block-uz">
                                                <?= $model->getFullAddress('uz') ?: 'Not specified' ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
