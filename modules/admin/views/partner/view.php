<?php
use app\widgets\admin_partner_menu\AdminPartnerMenu;
use app\widgets\admin_language_tab\AdminLanguageTab;

$this->title = $model ? $model->name_ru : 'Affiliate program';
...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php if (Yii::$app->session->hasFlash('partner_saved')) {?>
            <div class="callout callout-success text-center">
                <?=Yii::$app->session->getFlash('partner_saved');?>
            </div>
        <?php }?>
        <?php if (Yii::$app->session->hasFlash('partner_locked')) {?>
            <div class="callout callout-success text-center">
                <?=Yii::$app->session->getFlash('partner_locked');?>
            </div>
        <?php }?>
        <div class="row">
            <div class="col-sm-3">
                <?=AdminPartnerMenu::widget();?>
            </div>
            <div class="col-sm-9">
                ...
                <div class="box box-info color-palette-box">
                    ...
                    <div class="box-body">
                        <div class="lang-block lang-block-ru">
                            <?=$model->description_mini_ru ? $model->description_mini_ru : '<div class="alert alert-warning text-center">No data</div>';?>
                        </div>
                        <div class="lang-block lang-block-uz">
                            <?=$model->description_mini_uz ? $model->description_mini_uz : '<div class="alert alert-warning text-center">No data</div>';?>
                        </div>
                        <div class="lang-block lang-block-en">
                            <?=$model->description_mini_en ? $model->description_mini_en : '<div class="alert alert-warning text-center">No data</div>';?>
                        </div>
                    </div>
                </div>
                <div class="box box-info color-palette-box">
