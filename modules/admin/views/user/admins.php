    ...
    <section class="content">
        <div class="box box-info color-palette-box">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-shield"></i> Список администраторов</h3>
                <div class="pull-right">
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/user/create', 'role' => \app\models\user\User::ROLE_ADMIN])?>" class="btn btn-primary">
            ...
            <div class="box-body" id="item-block">
                <?= GridView::widget([
                    ...
                    'summary' => "Показано {begin} - {end} из {totalCount} администраторов<br/><br/>",
