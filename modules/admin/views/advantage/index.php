...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php if (Yii::$app->session->hasFlash('advantage_removed')) {?>
            <div class="callout callout-success text-center">
                <?=Yii::$app->session->getFlash('advantage_removed');?>
            </div>
        <?php }?>
        <div class="box box-info color-palette-box">
            <div class="box-header with-border">
                <div class="box-title pull-right" style="font-size: 14px">
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/advantage/create'])?>" class="btn btn-primary">
            ...
            <div class="box-body" id="item-block">
                <?= GridView::widget([
                    ...
                    'summary' => "Page {begin} - {end} of {totalCount} benefits<br/><br/>",
                    'emptyText' => 'No advantage',
                    'rowOptions' => function ($model, $index, $widget, $grid) {
                        return [
                            'id' => $model['id'],
                            'url' => Yii::$app->urlManager->createUrl('/admin/advantage/view').'?id='.$model['id']
                        ];
                    },
                    'tableOptions' => [
                        ...
                        [
                            ...
                            'buttons' => [
                                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['/admin/advantage/create', 'id'=>$model->id]), ['class'=>'btn btn-warning']);
                                },
                                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span>', Yii::$app->urlManager->createUrl(['/admin/advantage/remove', 'id'=>$model->id]), ['class'=>'btn btn-danger remove-object']);
                                }
                            ],
                        ]
                    ],
